...
namespace UIAPI.Interfaces.InstrumentAccess
{
    ...
    public interface IUMessage : exploris.Thermo.Interfaces.InstrumentAccess_V1.IMessage, Thermo.Interfaces.InstrumentAccess_V1.IMessage
  {
    ...
    /// </summary>
    public class UMessagesArrivedEventArgs : EventArgs
    {
        /// <summary>
        /// Get access to the messages that have arrived from all instrument and the transport layer.
        /// </summary>
        public IList<IUMessage> Messages;

        /// <summary>
        /// Create a new Exploris Thermo.Interfaces.InstrumentAccess_V1.MessagesArrivedEventArgs.
        /// </summary>
        /// <param name="e"></param>
        public UMessagesArrivedEventArgs(exploris.Thermo.Interfaces.InstrumentAccess_V1.MessagesArrivedEventArgs e)
        {
            foreach (var v in e.Messages)
            {
                Messages.Add(new UMessage(v));
            }
        }
        ...
        /// </summary>
        /// <param name="e"></param>
        public UMessagesArrivedEventArgs(Thermo.Interfaces.InstrumentAccess_V1.MessagesArrivedEventArgs e)
        {
            foreach (var v in e.Messages)
            {
                Messages.Add(new UMessage(v));
