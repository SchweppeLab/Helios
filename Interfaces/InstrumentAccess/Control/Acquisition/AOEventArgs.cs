...
namespace UIAPI.Interfaces.InstrumentAccess.Control.Acquisition
{
    ...
    /// </summary>
    public class AOEventArgs : EventArgs
    {
        /// <summary>
        /// From IAPI Docs:<br/>
        ...
        public AOEventArgs(exploris.Thermo.Interfaces.InstrumentAccess_V1.Control.Acquisition.AcquisitionOpeningEventArgs e)
        {
        ...
        public AOEventArgs(Thermo.Interfaces.InstrumentAccess_V1.Control.Acquisition.AcquisitionOpeningEventArgs e)
        {
            StartingInformation = e.StartingInformation;
        }
    }
