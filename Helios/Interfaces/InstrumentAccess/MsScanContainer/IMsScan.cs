...
namespace Helios.Interfaces.InstrumentAccess.MsScanContainer
{
  ...
  internal class HeliosMsScanFusion : IMsScan
  {
    ...
    public HeliosMsScanFusion(Thermo.Interfaces.InstrumentAccess_V1.MsScanContainer.IMsScan m)
    {
      ...
      {
        CentroidList.Add(new Centroid(centroid.Mz,centroid.Intensity,centroid.Charge,centroid.Resolution,centroid.IsMonoisotopic));
      }
      if (m.ChargeEnvelopes != null)
      {
        ChargeEnvelopes = new IChargeEnvelope[m.ChargeEnvelopes.Length];
  ...
  internal class HeliosMsScanVMS : IMsScan
  {
    ...
    public HeliosMsScanVMS(Spectrum m)
    {
      ...
      Header.Add("MasterScan", m.PrecursorMasterScanNumber.ToString());
      ...
      trailer.Add("Master Index", m.MasterIndex.ToString());
      trailer.Add("Master Scan Number", m.PrecursorMasterScanNumber.ToString());
      ...
      {
        CentroidList.Add(new Centroid(dp.Mz, dp.Intensity,null,null,null));
      }
    }
    ...
    public HeliosMsScanVMS(SpectrumEx m)
    {
      ...
      foreach (var dp in m.DataPoints)
      {
        CentroidList.Add(new Centroid(dp.Mz, dp.Intensity, dp.Charge, dp.Resolution, null));
      }
    }
